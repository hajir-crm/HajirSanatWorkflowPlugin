...
{
    public class SentPeropertyProducts : CodeActivity
    {
        #region Parameters
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            using (var crm = new XrmServiceContext(service))
            {
                ...
                QuoteProduct.rhs_WarrantyPeriod = ProductItems.rhs_Warrantyperiod;
                QuoteProduct.rhs_ProductID = ProductItems.ProductNumber;
